...
export const InsightsSheetLife = ({ open, onOpenChange, mode = "context" }: InsightsSheetProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center" dir="rtl" style={{ height: "100dvh" }}>
      ...
      >
        ...
        <div className="tri-ring-life absolute left-1/2 -translate-x-1/2 w-16 h-16 rounded-full" style={{ top: "-32px" }}>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex justify-start" dir="ltr">
                          <button className="cta-tri-life inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold transition-transform hover:scale-[1.02] active:scale-[0.98]">
                            {t.cta}
        ...
        <div className="px-5 py-3 border-t" style={{ borderColor: "hsl(230, 20%, 93%)", background: "white" }} dir="rtl">
          ...
          >
            ...
            <button
              onClick={handleSend}
              disabled={!input.trim()}
              className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-all hover:scale-105 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed ${input ? "cta-tri-life" : ""}`}
              style={{

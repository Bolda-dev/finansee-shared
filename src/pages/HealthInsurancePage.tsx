  ...
  return (
    <div className="min-h-screen max-w-[430px] mx-auto relative" dir="rtl" style={{ background: C.soft }}>
      ...
      >
        ...
        {/* Breadcrumb */}
        <nav className="relative inline-flex items-center text-[12px] font-semibold text-white/85" aria-label="breadcrumb">
          ...
          <button onClick={() => navigate("/insurance")} className="px-1.5 py-1 opacity-75 hover:opacity-100 transition-opacity">
            ביטוח
          </button>
          <span className="mx-2.5 opacity-50">/</span>
          <span className="font-extrabold text-white truncate max-w-[160px]">ביטוח בריאות</span>
        </nav>

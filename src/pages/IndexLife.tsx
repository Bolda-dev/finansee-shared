            ...
            {[
              {
                ...
                shadow: "0 2px 6px hsla(75, 80%, 40%, 0.20)",
                glow: "hsla(75, 80%, 40%, 0.10)",
                outline: "hsla(75, 70%, 35%, 0.20)",
                iconColor: "hsl(0, 0%, 8%)",
                textOnBold: "hsl(0, 0%, 8%)",
              ...
              },
              {
                ...
                shadow: "0 2px 6px hsla(0, 0%, 0%, 0.25)",
                glow: "hsla(0, 0%, 0%, 0.20)",
                outline: "hsla(0, 0%, 0%, 0.15)",
                iconColor: "hsl(0, 0%, 8%)",
                textOnBold: "hsl(0, 0%, 100%)",
              ...
              },
              {
                ...
                shadow: "0 2px 6px hsla(245, 76%, 45%, 0.20)",
                glow: "hsla(245, 76%, 45%, 0.15)",
                outline: "hsla(245, 76%, 45%, 0.15)",
            ...
            {(() => {
              ...
              const categoryColors: Record<Category, { accent: string; accentBg: string; bar: string }> = {
                assets: {
                  ...
                  bar: "linear-gradient(90deg, hsl(75, 80%, 50%) 0%, hsla(70, 95%, 65%, 0.8) 100%)",
                },
                liabilities: {
                  accent: "hsl(0, 0%, 12%)",
                  accentBg: "hsl(0, 0%, 92%)",
                  bar: "linear-gradient(90deg, hsl(0, 0%, 4%) 0%, hsla(0, 0%, 30%, 0.8) 100%)",
                },
                insurance: {
                  accent: "hsl(245, 76%, 50%)",
                  accentBg: "hsl(245, 90%, 95%)",
                  bar: "linear-gradient(90deg, hsl(245, 70%, 45%) 0%, hsla(245, 76%, 65%, 0.8) 100%)",
                },
              };

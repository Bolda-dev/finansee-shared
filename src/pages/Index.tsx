            ...
            <div className="flex items-center gap-1.5">
              ...
              <div className="relative z-[9999]">
                ...
                {(showTooltip || autoTooltip) && (
                  <div
                    className="absolute bottom-full right-0 mb-2 w-56 bg-white text-foreground text-xs rounded-xl p-3 shadow-xl z-[9999] animate-fade-in border border-border"
                  >

            ...
            if (card.category === "assets") {
              return (
                <button
                  key={card.label}
                  onClick={() => navigate(card.route)}
                  className="relative rounded-2xl px-2.5 py-3 text-start flex flex-col overflow-hidden transition-transform active:scale-[0.97]"
                  style={{
                    background: p.gradient,
                    boxShadow: `0 8px 24px hsla(176, 70%, 22%, 0.4)`,
                    minHeight: `${CARD_MIN_H}px`,
                  }}
                >
                  <div
                  ...
                  <p className="relative z-10 text-[11px] font-medium mb-1" style={{ color: "hsla(0, 0%, 100%, 0.9)" }}>
                    {card.label}
                  </p>
                  <p className="relative z-10 font-extrabold text-base mb-1.5 text-white">
                    ₪3.3M
                  </p>

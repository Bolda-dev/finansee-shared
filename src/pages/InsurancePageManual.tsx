...
const InsurancePageManual = () => {
  const { colors } = useManualPalette();
  const c = colors.insurance;
  ...
  return (
    <CategoryPageC
      ...
      renderItemTrailing={(item) => {
        ...
        return (
          <span className="text-[11px] font-semibold px-2 py-0.5 rounded-full" style={{ background: "hsl(0, 80%, 95%)", color: "hsl(0, 65%, 45%)" }}>
            חסר
          </span>
        );
      }}
...
export default InsurancePageManual;
